...
- [x] Glowing obsidian;
- [ ] White leaves;
- [ ] UPD, 3d hook, wither potion, compass map, color sheep, colorful shulker, squid sound
- [ ] piston col, cyan flower, copper horn, npc
...
- [x] Iron bars, iron block, iron trapdoor, iron door, and heavy weighted pressure plate added new sounds;
...
- [x] Changed the rules for sheep coloring to be based on which biome they spawn in;
